...
class Meeting(models.Model):
    ...
    rrule_type_ui = fields.Selection(RRULE_TYPE_SELECTION_UI, string='Repeat', readonly=False,
    ...
    def _set_discuss_videocall_location(self):
        ...
        This is done by design to prevent users not being able to join a discuss meeting because the base event of the  was deleted.
        """
