    ...
    def _get_next_potential_limit_alarm(self, alarm_type, seconds=None, partners=None):
        ...
        base_request = """
            SELECT
                ...
                CASE
                    WHEN cal.recurrence_id IS NOT NULL THEN rrule.until - interval '1' minute * calcul_delta.min_delta
                    ELSE cal.stop - interval '1' minute * calcul_delta.min_delta
                END AS last_alarm,
                cal.start AS first_event_date,
                CASE
                    WHEN cal.recurrence_id IS NOT NULL AND rrule.end_type = 'end_date' THEN rrule.until
                    ELSE cal.stop
